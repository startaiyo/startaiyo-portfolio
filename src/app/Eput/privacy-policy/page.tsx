export default function Page() {
    return (
        <div style={styles.container}>
            ...
            <h2 style={styles.subheading}>Third Party Access</h2>
            <p style={styles.paragraph}>
            ...
            <h2 style={styles.subheading}>Opt-Out Rights</h2>
            <p style={styles.paragraph}>
            ...
            <h2 style={styles.subheading}>Changes</h2>
            <p style={styles.paragraph}>
                This Privacy Policy may be updated from time to time for any reason. The Service Provider will notify you of any changes to the Privacy Policy by updating this page with the new Privacy Policy. You are advised to consult this Privacy Policy regularly for any changes, as continued use is deemed approval of all changes.
            </p>
            <p style={styles.paragraph}>This privacy policy is effective as of 2024-06-25</p>
            <h2 style={styles.subheading}>Your Consent</h2>
            <p style={styles.paragraph}>
                By using the Application, you are consenting to the processing of your information as set forth in this Privacy Policy now and as amended by us.
            </p>
            <h2 style={styles.subheading}>Contact Us</h2>
            <p style={styles.paragraph}>
                If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at starsunyo0104@gmail.com.
            </p>
            <hr style={styles.hr}/>
            <p style={styles.generator}>
                This privacy policy page was generated by <a href="https://app-privacy-policy-generator.nisrulz.com/" target="_blank" rel="noopener noreferrer" style={styles.link}>App Privacy Policy Generator</a>
            </p>
        </div>
    );
}
